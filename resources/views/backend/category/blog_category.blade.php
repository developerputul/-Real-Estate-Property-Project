...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
          ...
          <button type="button" class="btn btn-inverse-light" data-bs-toggle="modal"
            ...
            <button type="button"  class="btn btn-inverse-warning" 
                 data-bs-toggle="modal" data-bs-target="#catedit" id="{{ $item->id }}" onclick="categoryEdit(this.id)">
                Edit
             </button>
