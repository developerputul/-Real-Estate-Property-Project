      ...
      <!-- middle wrapper start -->
            <div class="col-md-12 col-xl-12 middle-wrapper">
              <div class="row">
                ...
                <form method="post" action="{{ route('agent.update.property') }}" 
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <a href="https://www.latlong.net/convert-address-to-lat-long.html"
                                 target="blank">Go here to get Latitude from address </a>
                            </div>
                        </div><!-- Col -->
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <a href="https://www.latlong.net/convert-address-to-lat-long.html"
                                target="blank">Go here to get Longitude from address </a>
                            </div>
                        </div><!-- Col -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <select name="amemities_id[]" class="js-example-basic-multiple form-select" 
                                    multiple="multiple"
                                    data-width="100%">
      ...
      <!-- middle wrapper start -->
            <div class="col-md-12 col-xl-12 middle-wrapper">
              <div class="row">
                ...
                <form method="post" action="{{ route('agent.update.property.thambnail') }}" 
                id="myForm" enctype="multipart/form-data">
                    @csrf
...
{{-- // End Property Main Thambnail Inage Update//  --}}



{{-- //  Property Multi Inage Update//  --}}
<div class="page-content" style="margin-top: -30px;">
    <div class="row profile-body">
      <!-- middle wrapper start -->
            <div class="col-md-12 col-xl-12 middle-wrapper">
        ...
        <form method="post" action="{{ route('agent.update.property.multiimage') }}" 
        id="myForm" enctype="multipart/form-data">
            @csrf
    ...
    <div class="table-responsive">
        ...
        <tbody>
            ...
            <input type="file" class="form-control" name="multi_img[{{ $img->id }}]">
                ...
                <a href="{{ route('agent.property.multiimage.delete', $img->id) }}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            @endforeach
    ...
    <br><br>
        ...
        <form method="post" action="{{ route('agent.store.new.multiimage') }}" 
                id="myForm" enctype="multipart/form-data">
                    @csrf
...
{{-- // End Property Multi Inage Update//  --}}
      ...
      <!-- middle wrapper start -->
            <div class="col-md-12 col-xl-12 middle-wrapper">
              <div class="row">
                ...
                <form method="post" action="{{ route('agent.update.property.facilities') }}" 
                id="myForm" enctype="multipart/form-data">
                    @csrf
