                ...
                $.each(response.wishlist, function(key,value){
                    ...
                    rows += `<div class="deals-block-one">
                        <div class="inner-box">
                            ...
                            <li><a type="submit" class="text-body" id="${value.id}" onclick="wishlistRemove(this.id)">
                ...
                $.each(response, function(key,value){
                    ...
                    rows += ` <tr>
                            ...
                            <tr>
                                ...
                                <td>
                            <a type="submit" class="text-body" id="${value.id}" onclick="compareRemove(this.id)">
