                        ...
                        <div class="comments-area">
                            ...
                            @foreach ($comment as $com)
                                ...
                                <img src="{{ !empty($com->user->photo) ?
                                    url('upload/user_image/'.$com->user->photo) : url('upload/no_image.jpg')}}" alt="">
                                    </figure>
                    ...
                    <div class="blog-sidebar">
                        ...
                        <div class="sidebar-widget social-widget">
                            ...
                            <ul class="social-links clearfix">
                                ...
                                <li><a href="blog-1.html"><i class="fab fa-youtube"></i></a></li>
                        ...
                        <div class="sidebar-widget category-widget">
                            ...
                            $post = App\Models\BlogPost::where('blogcat_id',$cat->id)->get();
                                @endphp
                                    ...
                                    <li>
                                    <a href="{{ url('blog/cat/list/'.$cat->id) }}">{{ $cat->category_name }}<span>({{ count($post) }})</span>
                                    </a>
                                </li>
                                @endforeach
